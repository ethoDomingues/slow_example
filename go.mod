...
require (
	...
	github.com/ethodomingues/slow_example/api v0.0.0-00010101000000-000000000000
	github.com/ethodomingues/slow_example/cdn v0.0.0-00010101000000-000000000000
